...
public class publicInviteUserGocSkip extends baseTestSuite {
	...
	@Test(priority = 3, dependsOnMethods = "enterEmailScreen") // Google Auth
	public void googleAuthScreen() throws InterruptedException, AWTException {
		if (googleAuthCompulsory == true) {
			...
			Assert.assertTrue(result);
			log.info("googleAuth Screen Passed");
			test.log(LogStatus.PASS, "googleAuth Screen Passed");
		}
	}
	
	@Test(priority=4, dependsOnMethods="googleAuthScreen") //Fetch + Enter OTP
	public void enterOtpScreen() throws InterruptedException{
		...
		Assert.assertTrue(result);
		log.info("enterOTP Screen Passed");
		test.log(LogStatus.PASS, "enterOTP Screen Passed");
	}
	
	@Test(priority=5, dependsOnMethods="googleAuthScreen") //Get authentication response
	...
	@Test(priority = 6, dependsOnMethods = "getAuthResponse")// Validate url + Approve GDPR+ Create Team
	...
	@Test(priority=7, dependsOnMethods="joinTeamScreen")
	public void gdprScreen(){
		cc.gdprScreen();
	}
	
	@Test(priority=8, dependsOnMethods="gdprScreen") //Set user profile
	...
	@Test(priority=9, dependsOnMethods = "setUserProfile") //Validate if the user profile set is true
	...
	@Test(priority=10, dependsOnMethods="verifyProfileDetails") //set user password
	...
	@Test(priority=11, dependsOnMethods="setPassword")//invite User 
	...
	@Test(priority=12, dependsOnMethods="inviteUserScreen")
	public void addFlockCrx() throws Exception{
