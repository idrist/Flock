...
public class paidCanjoinNonGoc extends baseTestSuite {
	
	private static final Logger log = LogManager.getLogger(paidCanjoinNonGoc.class.getName());
	
	private String emailUsed = DefaultStrings.EMAIL_PAID_NOAUTOJOIN;
	...
	public void enterOtpScreen() throws InterruptedException{
		...
		boolean result = fl.canJoinPageHeading.isDisplayed() == true;
		Assert.assertTrue(result);
	...
	public void canJoinTeams() throws Exception{
		...
		if (fl.autoJoinedTeam.isDisplayed()) {
			...
			Thread.sleep(2000);
			boolean result1 = fl.updateProfilePic.isDisplayed();
