...
public class publicGocSkip extends baseTestSuite {
	...
	@Test(priority=5, dependsOnMethods="enterOtpScreen") //Get authentication response
	...
	@Test(priority = 6, dependsOnMethods = "getAuthResponse") // Validate url +
																// Approve GDPR
																// + Create Team
	...
	@Test(priority=7, dependsOnMethods="createTeamScreen") //Set user profile
	...
	@Test(priority=11, dependsOnMethods="inviteUser")
