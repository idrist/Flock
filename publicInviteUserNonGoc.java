...
public class publicInviteUserNonGoc extends baseTestSuite {
	private static final Logger log = LogManager.getLogger(publicInviteUserNonGoc.class.getName());

	private String emailUsed = DefaultStrings.EMAIL_PUBLIC_NONGOC;
	...
	@Test(priority = 5, dependsOnMethods = "getAuthResponse") // Validate url + Approve GDPR+ Create Team
