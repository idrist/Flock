...
public class RestUtilities {
	...
	public static ResponseSpecification RESONSE_SPEC;
	...
	public static RequestSpecification getRequestSpecification(){
		...
		REQUEST_BUILDER.setBaseUri(Path.BASE_STAGING_URI);
	...
	public static ResponseSpecification getResponseSpecification(){
		...
		RESONSE_SPEC = RESPONSE_BUILDER.build();
		return RESONSE_SPEC;
	...
	public static Response getResponse(RequestSpecification reqSpec, String type){
		...
		response.then().spec(RESONSE_SPEC);
		return response;
	}
