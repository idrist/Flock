...
public class paidAutojoinGoc extends baseTestSuite {
	private static final Logger log = LogManager.getLogger(publicNonGoc.class.getName());

	private String emailUsed = DefaultStrings.EMAIl_PAID_AUTOJOIN_GOC;
	...
	@Test(priority=8, dependsOnMethods="setUserProfile") //set user password
